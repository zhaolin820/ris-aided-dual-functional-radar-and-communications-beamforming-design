...
% rng(i1);
%rho_all = [1,20,50,80,100,200,250,300,350,400,450,500,900,1e3,2000,3000,8000,1e4,1e5,1e6,1e7,1e8,2e8];
% rho = rho_all(i1);
...
parfor step = 1:ite   
    ...
    [P, Rq, Theta, wsr] = WMMSE_FP_v2(para, h, Hc, Hr, dc, dr, ar, Z, rho);
...
save(['ris_data_' num2str(rho) '.mat'],'rho','wsr_average','prob_power_average','pattern_average');